        ...
        <form class="space-y-9" @submit.prevent="submitTicket">
            ...
            <div class="grid grid-cols-2 gap-6 sm:gap-16">
                ...
                <div>
                    ...
                    <UInput v-model="formData.firstName" placeholder="Entrez un prénom" color="primary"
...
}, { deep: true, immediate: true }) // immediate: true pour émettre les valeurs initiales
